      ...
      <div className="container contact">
        <div className="row p-3">
          <div className="col-lg-6">
            ...
            <p className="text-danger">Email: info@healthcare.com</p>
          ...
          <div className="col-lg-6">
            <div className="call-work mt-4">
              <h5>Call Directly</h5>
              <h1 className="text-danger">+880 123 456</h1>
            </div>
            <div className="call-work mt-4">
              <h5>Brand Officers:</h5>
              <p className="text-danger">
                Allenton Pa | Allanta, GA | Chicago IL | Dallas TX,
              </p>
              <p className="text-danger">Edison, NJ | Houston, TX</p>
            </div>
          </div>
        </div>
      </div>
